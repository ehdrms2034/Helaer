...
export default class HistoryPage extends Component {
    ...
    blood_type(){
        ...
        if(this.state.mobxStore.mydata.user_bloodType){
                        ...
                        <View style={styles.top_info_1}>
                            ...
                            <View style={styles.top_info_1_R}>
                                <View style={styles.top_info_1_R_lv}>
                                    ...
                                    <Text style={styles.top_info_1_R_lv_r}>{this.props.mobxStore.mydata.user_level}</Text>
                                </View>
                                <Text style={styles.top_info_1_R_name}>{this.props.mobxStore.mydata.user_nickname}</Text>
                            </View>
                        </View>
